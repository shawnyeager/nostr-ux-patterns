...
- <a id="data-19"></a>**[[Data:19]](/docs/research/references#data-21)** User complaints: Nostr apps "slow and clunky", "clients blasting entire message history" (2024)
- <a id="data-20"></a>**[[Data:20]](/docs/research/references#data-22)** Crash reports across Primal, Amethyst, Nostur, Damus clients (2024)
- <a id="data-21"></a>**[[Data:21]](/docs/research/references#data-23)** Database identified as "core bottleneck" for slow feed loading; gap vs Twitter's Redis architecture (2024)
- <a id="data-22"></a>**[[Data:22]](/docs/research/references#data-24)** Amethyst battery drain: Background video loops, up to 100 relay connections, improper WebSocket management (2024)
- <a id="data-23"></a>**[[Data:23]](/docs/research/references#data-18)** Only 639 relays online; default SQLite backend "worst performance"; free relays slower than paid (2024)
- <a id="data-24"></a>**[[Data:24]](/docs/research/references#data-25)** Clients can open hundreds of WebSocket connections simultaneously; one per relay (2024)
- <a id="data-25"></a>**[[Data:25]](/docs/research/references#data-26)** Black Hat USA 2025: Some clients omit signature verification for performance; security tradeoff (2025)
...
- <a id="research-33"></a>**[[Research:33]](/docs/research/references#research-43)** Conversion Impact: 39% at 1s load, 1.9% at 2.4s, 0.6% at 5.7s; 7% loss per second delay (2025)
- <a id="research-34"></a>**[[Research:34]](/docs/research/references#research-34)** Skeleton screens perceived 30% faster than spinners; best for <10s waits, container components (LogRocket, 2024)
- <a id="research-35"></a>**[[Research:35]](/docs/research/references#research-44)** Skeleton vs Spinners: More engaging, dramatic UX improvement despite identical speed (UI-Deploy, 2024)
- <a id="research-36"></a>**[[Research:36]](/docs/research/references#research-30)** React 19 useOptimistic Hook: Elegant optimistic UI solution for social media (LogRocket, 2024)
- <a id="research-37"></a>**[[Research:37]](/docs/research/references#research-45)** Material Design 3 Expressive loading indicator for <5s waits; 7 unique shape morphs (May 2025)
- <a id="research-38"></a>**[[Research:38]](/docs/research/references#research-46)** React Optimistic UI vital for social media: Facebook like button turns blue instantly (Telerik, 2025)
- <a id="research-39"></a>**[[Research:39]](/docs/research/references#research-47)** Service Workers + IndexedDB significantly improves performance, enables offline-first apps (September 2024)
- <a id="research-40"></a>**[[Research:40]](/docs/research/references#research-48)** Offline-First PWAs: 45% use hybrid approach; Cache API for files, IndexedDB for data (August 2025)

- <a id="research-41"></a>**[[Research:41]](/docs/research/references#research-49)** JS Bundle Size: Tree shaking, code splitting, dynamic import() reduce bundles 20-50% (2025)
- <a id="research-42"></a>**[[Research:42]](/docs/research/references#research-50)** Webpack Bundles: <250KB gzipped initial, <1MB total for good UX (2025)
- <a id="research-43"></a>**[[Research:43]](/docs/research/references#research-51)** React Server Components: 40% faster loads, 15% conversion increase; no JS shipped to client (2024)
- <a id="research-44"></a>**[[Research:44]](/docs/research/references#research-52)** Native Lazy Loading: 97.5% images load <10ms on 4G, 92.6% on 2G; WebP/AVIF more efficient (2024)
- <a id="research-45"></a>**[[Research:45]](/docs/research/references#research-53)** React Performance: Virtual scrolling/windowing essential for large lists, reduces DOM ops (2025)
- <a id="research-46"></a>**[[Research:46]](/docs/research/references#research-54)** React Virtualization: Only render visible elements; reduces DOM updates, memory, render time (2024)
- <a id="research-47"></a>**[[Research:47]](/docs/research/references#research-55)** TanStack Virtual: Most popular library; use React.memo(), combine with pagination, overscan 1-2 items (November 2024)
- <a id="research-48"></a>**[[Research:48]](/docs/research/references#research-56)** Nostr Replication Overhead (arXiv): Control replication count, reduce retrieval overhead (Wei & Tyson, September 2025)
- <a id="research-49"></a>**[[Research:49]](/docs/research/references#research-57)** INP Replaces FID as Core Web Vital: March 12, 2024; measures all interactions vs first only (2024)
- <a id="research-50"></a>**[[Research:50]](/docs/research/references#research-58)** INP vs FID: INP measures input+processing+paint; Good <200ms, Poor >500ms (Vercel, 2024)
- <a id="research-51"></a>**[[Research:51]](/docs/research/references#research-59)** 60fps Animation: 16.7ms budget; GPU-accelerated transform/opacity smoother (MDN, November 2025)
- <a id="research-52"></a>**[[Research:52]](/docs/research/references#research-60)** Rakuten CWV: Good LCP = 61% conversion increase, 26% revenue/visitor increase (web.dev, 2024)
- <a id="research-53"></a>**[[Research:53]](/docs/research/references#research-61)** Core Web Vitals Impact: 24% less abandonment, 8-10% conversion per 0.1s improvement (2024)

### Case Studies & Examples (Mainstream Apps)

- <a id="example-11"></a>**[[Example:11]](/docs/research/references#example-17)** Twitter/X: Algorithm runs 5 billion times/day, <1.5s average execution for personalized For You feed (2025)
- <a id="example-12"></a>**[[Example:12]](/docs/research/references#example-18)** Instagram: AI picks 500 posts/user; "Engage in first 3 seconds"; Reels 2.46% engagement (2025)
- <a id="example-13"></a>**[[Example:13]](/docs/research/references#example-19)** TikTok: Watch time priority; content must "stop scrolls cold"; brands post 6x/week (2025)
- <a id="example-14"></a>**[[Example:14]](/docs/research/references#example-20)** Starbucks PWA: 2x daily users, 53% more completions; <1MB, <1s load (2025)
- <a id="example-15"></a>**[[Example:15]](/docs/research/references#example-21)** Discord: 84% crash reduction iOS, 30% faster switching, 80% faster GIFs, 25% less latency (Dec 2024)
